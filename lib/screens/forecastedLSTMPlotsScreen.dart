...
class ForecastedLSTMPlot extends StatelessWidget {
  ...
  Widget build(BuildContext context) {
    ...
    return Scaffold(
      ...
      //   ),),
      // ),
      body: ForecastedLSTMPlotFromAPI(),
    );
  }
}

class ForecastedLSTMPlotFromAPI extends StatefulWidget {
  @override
  _ForecastedLSTMPlotFromAPIState createState() => _ForecastedLSTMPlotFromAPIState();
}

class _ForecastedLSTMPlotFromAPIState extends State<ForecastedLSTMPlotFromAPI> {
  String imageUrl = flask_url+'/futurepredictionlstm'; // Replace with your Flask API URL
